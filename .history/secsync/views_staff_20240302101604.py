   ...
   if serializer.is_valid():
      ...
      try:
         ...
         try:
            ...
            message = "Hi and welcome to VoisekB2C. You default password is "+ raw_password +" and your activating OTP is "+otp+". Please activate your account"
