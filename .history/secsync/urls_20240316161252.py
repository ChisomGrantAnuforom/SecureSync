...
urlpatterns = [
    ...
    path('api/v1/patient_record/register_patient/', views_patient_record.registerPatient, name="register_patient"),
    path('api/v1/patient_record/get_patient_by_phone_number/', views_patient_record.getPatientByPhoneNumber, name="get_patient_by_phone_number"),
    path('api/v1/patient_record/get_patient_by_id/<str:patient_id>/', views_patient_record.getPatientById, name="get_patient_by_id"),
